<html>
    ...
    <body bgcolor="#87ceeb" leftmargin="120px" >
        ...
        <form action="writent.php" method="POST">
            ...
            <font style="position: relative; left: 100px; top: 0px;" >氏名</font><input type="text" name="simei" size="40" disabled="disabled" value="<?php echo$data2 ?>" style="position: relative; left: 400px; top: 0px;"><br>
            <font style="position: relative; left: 100px; top: 0px;" >宿泊人数</font><input type="text" name="ninzu" size="40" disabled="disabled" value="<?php echo$data3 ?>" style="position: relative; left: 368px; top: 0px;"><font style="position: relative; left: 368px; top: 0px;" >人</font><br>
            <font style="position: relative; left: 100px; top: 0px;" >宿泊期間</font><input type="text" name="nen" size="20"disabled="disabled"  value="<?php echo$data4 ?>" style="position: relative; left: 368px; top: 0px;"><font style="position: relative; left: 368px; top: 0px;" >年</font>
   ...
   　    <input type="text" name="" size="40"  value="<?php echo$bhun ?>" disabled="disabled" style="position: relative; left: 400px; top: 0px;"><br><br><br>
            ...
            <input type="button" value=" 戻る" onClick="location.href = 'eatnt.php'" style="position: relative; left: 1000px; top: 0px;"/>
