...
<html>
    ...
    <body bgcolor="#87ceeb">
      ...
      <div style="padding: 50px;border: 5px dashed #00008b; text-align: center; width: 70%; ">
    ...
    　　<br/>ありがとう<font color="#4169e1">ご</font>ざいます。
      　<br/>皆様に<font color="#ff0000">良</font>い旅にしていただく<font color="#00bfff">為</font>に
        <br/>ご到<font color="#ffd700">着</font>からの行動をお<font color="#008000">知</font>らせ下さい。
            ...
            <input type="button"onClick="location.href='reservent.php'" value="ログイン" style="width:100px;height:50px;position: relative; left:550px; top: 50px;" />
