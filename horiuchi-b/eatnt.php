...
<body bgcolor="#87ceeb"leftmargin="120px">
    <font size="7">お<font color="#33cccc">食</font>事について</font>
<br><br><br>
<form action="institutionnt.php" method="get">
<font size="5" style="position: relative; left: 100px; top: 0px;" >夕食</font>
<input type="radio" name="dinner" value="指定する"style="position: relative; left: 300px; top: 0px;"checked>
<font size="5"style="position: relative; left: 300px; top: 0px;" >指定する</font>
<SELECT name="dzi" style="position: relative; left: 320px; top: 0px;">

 <OPTION value="18時">18</OPTION>
 <OPTION value="19時">19</OPTION>
 <OPTION value="20時">20</OPTION>
</SELECT>
<font size="4"style="position: relative; left: 340px; top: 0px;" >：</font> 
<SELECT name="dhun" style="position: relative; left: 360px; top: 0px;">
...
<br><br>
<input type="radio" name="dinner" value="指定しない"style="position: relative; left: 353px; top: 0px;">
<font size="5"style="position: relative; left: 354px; top: 0px;" >指定しない</font>
<br><br><br>
<font size="5" style="position: relative; left: 100px; top: 0px;" >朝飯</font>
<input type="radio" name="breakfast" value="指定する"style="position: relative; left: 300px; top: 0px;"checked>
<font size="5"style="position: relative; left: 300px; top: 0px;" >指定する</font>
<SELECT name="bzi" style="position: relative; left: 320px; top: 0px;">
 <OPTION value="07時">07</OPTION>
 <OPTION value="08時">08</OPTION>
 <OPTION value="09時">09</OPTION>
</SELECT>
<font size="4"style="position: relative; left: 340px; top: 0px;" >：</font> 
<SELECT name="bhun" style="position: relative; left: 360px; top: 0px;">
 <OPTION value="00分">00</OPTION>
 <OPTION value="01分">01</OPTION>
 <OPTION value="02分">02</OPTION>
 <OPTION value="03分">03</OPTION>
...
<br><br>
<input type="radio" name="breakfast" value="指定しない"style="position: relative; left: 353px; top: 0px;">
<font size="5"style="position: relative; left: 354px; top: 0px;" >指定しない</font>


<input type="submit" value="次へ" style="position: relative; left: 400px; top: 100px;"/>
  <input type="button" value=" 戻る" onClick="location.href='reserve.php'" style="position: relative; left: 400px; top: 100px;"/>
</form>
</body>
</html>